...
class CreateCategoryRoute extends _i12.PageRouteInfo<void> {
  const CreateCategoryRoute({List<_i12.PageRouteInfo>? children})
...
class CreateServiceItemRoute extends _i12.PageRouteInfo<void> {
  const CreateServiceItemRoute({List<_i12.PageRouteInfo>? children})
    : super(CreateServiceItemRoute.name, initialChildren: children);
  ...
  static _i12.PageInfo page = _i12.PageInfo(
    name,
    builder: (data) {
      return const _i3.CreateServiceItemScreen();
    },
  );
}
...
/// generated route for
/// [_i6.EmployeeScreen]
class EmployeeRoute extends _i12.PageRouteInfo<void> {
  const EmployeeRoute({List<_i12.PageRouteInfo>? children})
...
/// generated route for
/// [_i9.ServiceItemsScreen]
class ServiceItemsRoute extends _i12.PageRouteInfo<void> {
  const ServiceItemsRoute({List<_i12.PageRouteInfo>? children})
  ...
  static _i12.PageInfo page = _i12.PageInfo(
    name,
    builder: (data) {
      return const _i9.ServiceItemsScreen();
    },
  );
}
