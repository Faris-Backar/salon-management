...
//         return false;
//       }
//       if (_employee != null && transaction.employee != _employee) {
//         return false;
//       }
//       if (_serviceName != null) {
//         bool serviceFound = transaction.selectedServices
//             .any((service) => service.name.contains(_serviceName!));
//         if (!serviceFound) {
//           return false;
//         }
//       }
...
//   void _applyFilters(
//       DateTime? fromDate, DateTime? toDate, String? employee, String? service) {
//     setState(() {
//       _startDate = fromDate;
//       _endDate = toDate;
//       _employee = employee;
...
//                       ? Center(child: Text(transactionState.errorMessage!))
...
//                                   child: ListTile(
//                                     title: Text(
//                                         'Service: ${transaction.selectedServices.first.name}'),
//                                     subtitle: Text(
...
//         onPressed: () {
//           // Variables to hold filter values within the dialog
...
//                       // Employee Dropdown - Now populated from the employee provider
//                       Text('Employee:',
//                           style: TextStyle(fontWeight: FontWeight.bold)),
//                       SizedBox(height: 8),
//                       Container(
...
//                               ),
//                               ...employeeOptions.map((String value) {
...
//                               ),
//                               ...serviceOptions.map((String value) {
//                                 return DropdownMenuItem<String>(
//                                   value: value,
//                                   child: Text(value),
//                                 );
...
//                     onPressed: () {
//                       _applyFilters(
//                           fromDate, toDate, selectedEmployee, selectedService);
//                       Navigator.pop(context);
//                     },
//                     child: Text('Apply'),
//                   ),
...
//           onChanged: (value) {
//             setState(() {
//               _employee = value.isEmpty ? null : value;
//             });
//           },
//         ),
//         TextField(
//           decoration: InputDecoration(labelText: 'Filter by Service Name'),
//           onChanged: (value) {
//             setState(() {
//               _serviceName = value.isEmpty ? null : value;
//             });
//           },
//         ),
//       ],
  ...
  void _applyFilters(
    ...
    setState(() {
      ...
      _showActiveFilters = _startDate != null ||
          ...
          (_serviceName != null && _serviceName!.isNotEmpty);
    });
  }
